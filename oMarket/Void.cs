...
namespace oMarket
{
    public partial class Void : Form
    {
        ...
        SqlDataReader dr;
        AnuleazaComanda cancelOrder;
        public Void(AnuleazaComanda cancel)
        {
            InitializeComponent();
        ...
        private void btnVoid_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr.HasRows)
                {
                    ...
                    MessageBox.Show("Comanda a fost anulata!", "Anulare comanda", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Dispose();
