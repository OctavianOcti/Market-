...
namespace oMarket
{
    public partial class ModulProdus : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (MessageBox.Show("Vreti sa salvati acest produs?", "Salvare produs", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cm.ExecuteNonQuery();
                    cn.Close();
                    MessageBox.Show("Produsul a fost salvat.", stitle);
                    Clear();
                    product.LoadProduct();
                }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (MessageBox.Show("Vreti sa actualizati produsul?", "Actualizare produs", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cm.ExecuteNonQuery();
                    cn.Close();
                    MessageBox.Show("Produsul a fost actualizat", stitle);
                    Clear();
                    this.Dispose();
                }
