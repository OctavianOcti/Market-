...
namespace oMarket
{
    public partial class RaportVanzari : Form
    {
        ...
        MainFormAdmin main;
        public RaportVanzari(MainFormAdmin mn)
        {
            InitializeComponent();
        ...
        private void dgvSold_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if(colName=="Cancel")
            {
                AnuleazaComanda cancelOrder = new AnuleazaComanda(this);
        ...
        {
            oMarketFactura report = new oMarketFactura();
        ...
        private void dgvSold_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if(colName=="Cancel")
            {
                AnuleazaComanda cancel = new AnuleazaComanda(this);
