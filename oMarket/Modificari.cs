...
namespace oMarket
{
    public partial class Modificari : Form
    {
        ...
        MainFormAdmin main;
        int _qty;
        public Modificari(MainFormAdmin mn)
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if(cbAction.Text=="")
                {
                    MessageBox.Show("Selectati metoda (adaugare/stergere).", "Atentioare", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    cbAction.Focus();
                    return;
                }
                ...
                if(txtQty.Text=="")
                {
                    MessageBox.Show("Introduceti cantitatea pe care doriti sa o modificati.", "Atentioare", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    txtQty.Focus();
                    return;
                }
                ...
                if(txtRemark.Text=="")
                {
                    MessageBox.Show("Adaugati un motiv pentru a modifica stocul.", "Atentionare", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    txtRemark.Focus();
                    return;
                }
                ...
                {
                    MessageBox.Show("Stocul pe care doriti sa il modificati trebuie sa fie mai mic decat stocul disponibil.", "Atentionare", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                MessageBox.Show("Stoc modificat.", "", MessageBoxButtons.OK, MessageBoxIcon.Information);
                LoadStock();
                Clear();
            ...
            {
                MessageBox.Show(ex.Message, "Atentionare", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
