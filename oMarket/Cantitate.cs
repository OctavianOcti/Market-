...
namespace oMarket
{
    public partial class Cantitate : Form
    {
        ...
        public Cantitate(MainformCasier cash)
        {
            InitializeComponent();
            ...
            if ((e.KeyChar == 13) && (txtQty.Text != string.Empty))
            {
                try
                {
                    ...
                    if (found)
                    {
                        ...
                        {
                            MessageBox.Show("Procesul nu a reusit. Cantiatea ramasa este " + qty, "Atentionare", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                            return;
                        }
                        cn.Open();
