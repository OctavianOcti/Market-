...
namespace oMarket
{
    public partial class MainFormAdmin : Form
    {
        ...
        {
            openChildForm(new Modificari(this));
            hideSubmenu();
        }

        private void btnSupplier_Click(object sender, EventArgs e)
        {
            openChildForm(new Furnizor());
            hideSubmenu();
        }
        ...
        {           
            openChildForm(new RaportVanzari(this));            
            hideSubmenu();
        }

        private void btnPosRecord_Click(object sender, EventArgs e)
        {
            openChildForm(new Inregistrari());
            hideSubmenu();
        }
        ...
        {
            openChildForm(new ContUtilizator(this));
            hideSubmenu();
        }
        ...
        private void btnLogout_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Iesire aplicatie?", "Iesire aplicatie", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                this.Hide();
        ...
        // alerta pentru produsele critice
        public void Noti()
        {
            int i = 0;
            cn.Open();
